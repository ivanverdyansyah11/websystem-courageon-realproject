                ...
                <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 gy-4">
                    <div class="col">
                        <div class="card-school-people text-center">
                            <img src="../img/employee1.png" alt="Siti Wulandari" class="w-100">
                    ...
                    <div class="col">
                        <div class="card-school-people text-center">
                            <img src="../img/employee2.png" alt="Andi Pratama" class="w-100">
                    ...
                    <div class="col">
                        <div class="card-school-people text-center">
                            <img src="../img/employee3.png" alt="Maya Fitriani" class="w-100">
                    ...
                    <div class="col">
                        <div class="card-school-people text-center">
                            <img src="../img/employee4.png" alt="Dina Wulandari" class="w-100">
