...
@section('container')
    <div class="content">
                ...
                <div class="row table-default">
                    <div class="col-12 table-row">
                        <div class="row table-data gap-4">
                            ...
                            <div class="col data-header">Judul <span class="d-none d-md-inline-block">Header</span>
                            </div>
                            ...
                            <div class="row table-data gap-4 align-items-center">
                                <div class="d-none d-md-inline-block col-2 data-value">
                                    @if ($section_header->banner)
                                        <img src="{{ asset('assets/img/akademik-images/header-image/' . $section_header->banner) }}"
        ...
        <div class="modal fade" id="deleteSectionHeaderModal" tabindex="-1"
            aria-labelledby="deleteSectionHeaderModalLabel" aria-hidden="true">
        ...
        <script>
            ...
            $(document).on('click', '[data-bs-target="#detailSectionHeaderModal"]', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: '/admin/akademik/detail-header/' + id,
                    success: function(data) {
                        ...
                        $('[data-value="banner_header"]').attr("src",
                            "/assets/img/akademik-images/header-image/" + data.banner);
            ...
            $(document).on('click', '[data-bs-target="#editSectionHeaderModal"]', function() {
                let id = $(this).data('id');
                $('#editSectionHeader').attr('action', '/admin/akademik/edit-header/' + id);
                $.ajax({
                    type: 'get',
                    url: '/admin/akademik/detail-header/' + id,
                    success: function(data) {
            ...
            $(document).on('click', '[data-bs-target="#deleteSectionHeaderModal"]', function() {
                let id = $(this).data('id');
                $('#deleteSectionHeader').attr('action', '/admin/akademik/delete-header/' + id);
            });
