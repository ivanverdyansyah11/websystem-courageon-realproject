...
@section('container')
                            ...
                            <div class="row table-data gap-4 align-items-center">
                                <div class="d-none d-md-inline-block col-2 data-value">
                                    @if ($section_header->banner)
                                        <img src="{{ asset('assets/img/humas-images/header-image/' . $section_header->banner) }}"
    ...
    <script>
        ...
        $(document).on('click', '[data-bs-target="#detailSectionHeaderModal"]', function() {
            ...
            $.ajax({
                type: 'get',
                url: '/admin/humas/detail-header/' + id,
        ...
        $(document).on('click', '[data-bs-target="#editSectionHeaderModal"]', function() {
            let id = $(this).data('id');
            $('#editSectionHeader').attr('action', '/admin/humas/edit-header/' + id);
            $.ajax({
                type: 'get',
                url: '/admin/humas/detail-header/' + id,
                success: function(data) {
        ...
        $(document).on('click', '[data-bs-target="#deleteSectionHeaderModal"]', function() {
            let id = $(this).data('id');
            $('#deleteSectionHeader').attr('action', '/admin/humas/delete-header/' + id);
        });
