    ...
    <div class="content">
        ...
        <script>
            ...
            $(document).on('click', '[data-bs-target="#detailSectionHeaderModal"]', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: '/admin/beranda/detail-header/' + id,
            ...
            $(document).on('click', '[data-bs-target="#editSectionHeaderModal"]', function() {
                let id = $(this).data('id');
                $('#editSectionHeader').attr('action', '/admin/beranda/edit-header/' + id);
                $.ajax({
                    type: 'get',
                    url: '/admin/beranda/detail-header/' + id,
                    success: function(data) {
            ...
            $(document).on('click', '[data-bs-target="#deleteSectionHeaderModal"]', function() {
                let id = $(this).data('id');
                $('#deleteSectionHeader').attr('action', '/admin/beranda/delete-header/' + id);
            });
