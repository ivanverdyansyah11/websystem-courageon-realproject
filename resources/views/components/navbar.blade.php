        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav gap-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('akademik') || Request::is('prestasi*') || Request::is('kategori-prestasi*') || Request::is('berita') || Request::is('manajemen') || Request::is('guru') || Request::is('pegawai') || Request::is('projek*') ? 'active' : '' }}"
...
<div class="w-100  {{  Request::is('beranda') || Request::is('profil') || Request::is('akademik') || Request::is('kesiswaan') || Request::is('sarana-prasarana') || Request::is('humas') ? 'd-none' : 'd-inline-block' }}" style="z-index: 999999">
