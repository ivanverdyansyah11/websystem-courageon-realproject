...
@section('container')
    ...
    <script>
        ...
        $(document).on('click', '[data-bs-target="#detailSectionHeaderModal"]', function() {
            ...
            $.ajax({
                type: 'get',
                url: '/admin/profil/detail-header/' + id,
        ...
        $(document).on('click', '[data-bs-target="#editSectionHeaderModal"]', function() {
            let id = $(this).data('id');
            $('#editSectionHeader').attr('action', '/admin/profil/edit-header/' + id);
            $.ajax({
                type: 'get',
                url: '/admin/profil/detail-header/' + id,
                success: function(data) {
        ...
        $(document).on('click', '[data-bs-target="#deleteSectionHeaderModal"]', function() {
            let id = $(this).data('id');
            $('#deleteSectionHeader').attr('action', '/admin/profil/delete-header/' + id);
        });
