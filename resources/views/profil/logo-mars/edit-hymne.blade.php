...
@section('container')
    <div class="content">
        ...
        <div class="row row-gap">
            <div class="col-12 d-flex justify-content-between align-items-center content-title">
                <h5 class="subtitle">Edit Hymne Sekolah</h5>
            </div>
            <div class="col-12">
                <form action="{{ route('hymne-update') }}" method="post"
                                        ...
                                        <div class="wrapper d-flex align-items-end">
                                            @if ($hymne->banner)
                                                <img src="{{ asset('assets/img/profil-images/hymne-image/' . $hymne->banner) }}"
                                                    class="img-fluid tag-edit-banner" alt="Banner Hymne Sekolah"
                                                    width="80">
                                            @else
                            ...
                            <div class="row">
                                <div class="col-6 mb-4">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="text" id="judul_section" class="input" autocomplete="off"
                                            value="{{ $hymne->title_section }}" required name="title_section">
                                        @error('title_section')
                                            <p class="caption-error mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6 mb-4">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="text" id="pencipta" class="input" autocomplete="off"
                                            value="{{ $hymne->creation }}" required name="creation">
                                        @error('creation')
                                            <p class="caption-error mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="input-wrapper">
                                        ...
                                        <textarea id="inputEditHymne" autocomplete="off" required name="hymne">
                                    {{ $hymne->hymne }}
                                    </textarea>
                                        @error('hymne')
                                            <p class="caption-error mt-2">{{ $message }}</p>
    ...
    <script>
        const editorTextEditMars = new RichTextEditor("#inputEditHymne");
