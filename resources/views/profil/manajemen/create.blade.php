                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="input-wrapper">
                                        ...
                                        <select name="status" id="status" class="input">
                                            <option selected>Pilih status manajemen</option>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="input-wrapper">
                                        <label for="work_tenure">Mana Kerja</label>
                    ...
                    <div class="row">
                        <div class="col-10">
                            <div class="button-wrapper d-flex gap-2">
                                ...
                                <button type="button" class="button-default" data-bs-dismiss="modal">Batal
                                    Tambah</button>
                            </div>
                        </div>
                    </div>
